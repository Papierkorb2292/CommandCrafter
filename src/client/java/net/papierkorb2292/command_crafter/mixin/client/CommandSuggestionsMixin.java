...
public class CommandSuggestionsMixin {
    ...
    @ModifyReceiver(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Ljava/util/concurrent/CompletableFuture;thenRun(Ljava/lang/Runnable;)Ljava/util/concurrent/CompletableFuture;"
            )
    )
    private CompletableFuture<Suggestions> command_crafter$ensureCompletionFutureRunsOnRenderThread(CompletableFuture<Suggestions> instance, Runnable action) {
