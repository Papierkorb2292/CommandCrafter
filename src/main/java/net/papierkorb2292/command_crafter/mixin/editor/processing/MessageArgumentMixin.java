...
public abstract class MessageArgumentMixin implements AnalyzingCommandNode {

    @Shadow public abstract MessageArgument.Message parse(StringReader stringReader) throws CommandSyntaxException;
