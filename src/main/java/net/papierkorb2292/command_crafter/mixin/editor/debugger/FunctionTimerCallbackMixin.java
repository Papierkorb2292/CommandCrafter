...
public class FunctionTimerCallbackMixin {
    ...
    private static int command_crafter$catchExecutionPausedThrowable(CommandFunctionManager manager, CommandFunction function, ServerCommandSource source, Operation<Integer> op) {
        try {
