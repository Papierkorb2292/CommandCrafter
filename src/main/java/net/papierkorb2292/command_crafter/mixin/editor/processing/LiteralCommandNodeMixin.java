...
public abstract class LiteralCommandNodeMixin<S> extends CommandNode<S> implements AnalyzingCommandNode, RedirectTargetChildAware {
    ...
    @Override
    public void command_crafter$analyze(@NotNull CommandContext<SharedSuggestionProvider> context, @NotNull StringRange range, @NotNull DirectiveStringReader<AnalyzingResourceCreator> reader, @NotNull AnalyzingResult result, @NotNull String name) {
