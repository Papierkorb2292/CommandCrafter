...
@Mixin(StringTemplate.class)
public class StringTemplateMixin implements MacroCursorMapperProvider {
    ...
    private static void command_crafter$setupLocalRefs(String command, CallbackInfoReturnable<StringTemplate> cir, @Share("cursorStarts") LocalRef<IntList> cursorStartsRef, @Share("allowMalformed") LocalBooleanRef allowMalformedRef) {
    ...
    @Inject(
            ...
            at = @At(
                    value = "NEW",
                    target = "(Ljava/util/List;Ljava/util/List;)Lnet/minecraft/commands/functions/StringTemplate;"
            )
    )
    private static void command_crafter$addLastSegmentCursorMapping(String command, CallbackInfoReturnable<StringTemplate> cir, @Local(ordinal = 1) int beginIndex, @Share("cursorStarts") LocalRef<IntList> cursorStartsRef) {
        cursorStartsRef.get().add(beginIndex);
    }
    ...
    private static StringTemplate command_crafter$addCursorMappingToInstance(StringTemplate macroInvocation, @Share("cursorStarts") LocalRef<IntList> cursorStartsRef) {
        ((StringTemplateMixin)(Object)macroInvocation).command_crafter$segmentCursorStarts = cursorStartsRef.get();
    ...
    @ModifyExpressionValue(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/commands/functions/StringTemplate;isValidVariableName(Ljava/lang/String;)Z"
            )
    )
