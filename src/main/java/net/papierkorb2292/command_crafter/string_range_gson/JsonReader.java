 ...
 * Copyright (C) 2024 Papierkorb2292
 *
...
public class JsonReader implements Closeable {
   ...
   * @throws com.google.gson.stream.MalformedJsonException if the next literal value is NaN or Infinity and this reader is
   ...
   *
   * @throws com.google.gson.stream.MalformedJsonException if the escape sequence is malformed
   */
  @SuppressWarnings("fallthrough")
  ...
  /**
   * Throws a new {@link com.google.gson.stream.MalformedJsonException} with the given message and information about the
   * current location.
   */
