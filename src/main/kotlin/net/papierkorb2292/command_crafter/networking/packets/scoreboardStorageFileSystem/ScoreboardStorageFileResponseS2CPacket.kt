...
class ScoreboardStorageFileResponseS2CPacket<TParams>(private val packetId: CustomPayload.Id<ScoreboardStorageFileResponseS2CPacket<TParams>>, val requestId: UUID, val params: TParams) : CustomPayload {
    companion object {
        ...
        val READ_FILE_RESPONSE_PACKET: Type<FileSystemResult<PartialReadFileResult>> = createType(Identifier.of("command_crafter", "scoreboard_storage_file_read_file_response"), FileSystemResult.createCodec(PartialReadFileResult.PACKET_CODEC))
